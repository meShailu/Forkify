...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); // window.addEventListener('hashchange', showReceipe);
...
array1.forEach((ev)=>window.addEventListener(ev, showReceipe));
console.log(array1);
